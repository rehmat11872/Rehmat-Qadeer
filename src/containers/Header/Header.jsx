...
const Header = () => {
  const { text: tagText } = useTypewriter({
    words: ["Mobile App Developer", "Andriod & IOS Developer", "Flutter Developer"],
    loop: true,
    typeSpeed: 100,
  });
  ...
  return (
    <div className="app__header app__flex">
        ...
        <div className="app__header-badge">
          <div className="badge-cmp app__flex">
            ...
            <div style={{ marginLeft: 20 }}>
              ...
              <p className="head-text">Rehmat Qadeer</p>
            </div>
          </div>
      ...
      >
        {[images.flutter, images.firebase, images.dart].map((circle, index) => (
          <motion.div
